    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-solid">
                <form role="form" method="post" action="{{ route('admin.page.update', ['id' => $page->id]) }}" id="page-form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div id="editormd">
                                <textarea class="editormd-markdown-textarea" style="display:none;" id="content" name="content">{{ $page->content }}</textarea>
                    ...
                    <div class="box-footer">
                        <button type="submit" id="submit-page" class="btn btn-primary">保存</button>
