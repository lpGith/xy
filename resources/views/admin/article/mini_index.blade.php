                ...
                <div class="box-header">
                    <form class="form-inline" action="" method="get">
                        <div class="pull-right">
                            <a href='{{ route("admin.article.mini-create") }}' class='btn btn-success btn-xs'>
                        ...
                        @if ($articles)
                            ...
                            @foreach($articles as $article=>$value)
                                <tr>
                                    ...
                                    <td>
                                        <a href='{{ route("admin.article.mini-edit", ["id" => $value->objectId]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("admin.article.mini-destroy", ["id" => $value->objectId]) }}'
