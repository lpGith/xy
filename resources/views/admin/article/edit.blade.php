...
@section('content')
    <div class="row">
        <div class="col-md-12">
            @include('admin.alert.warning')
            <div class="box box-solid">
                <form role="form" method="post" enctype="multipart/form-data" action="{{ route('admin.article.update', ['id' => $article->id]) }}" id="article-form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="desc">封面图(List_pic)</label>
                            <div class="row">
                                <div class='col-md-3'>
                                    <input type="file" name="list_pic" id="list_pic" accept="image/png,image/gif,image/jpeg" >
                                </div>
                                <div class='col-md-6'>
{{--                                    <input type='text' value="{{ $article->list_pic }}" class='form-control' name="list_pic" id='list_pic' placeholder='请输入列表图地址'>--}}
                                    <img src="{{ asset('uploads/avatar') }}/{{ $article->list_pic }}" class="img-circle" style="width:80px;height:auto;" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
@section('javascript')'
    ...
    <script>
        var editor = editormd("editormd", {
            ...
            imageUploadURL:"{{url('admin/uploadimage')}}"
        });
