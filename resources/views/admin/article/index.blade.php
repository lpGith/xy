                ...
                <div class="box-header">
                    <form class="form-inline" action="" method="get">
                        ...
                        <div class="pull-right">
                            <a href='{{ route("admin.article.create") }}' class='btn btn-success btn-xs'>
                        ...
                        @if ($articles)
                            ...
                            @foreach($articles as $article)
                                <tr>
                                    ...
                                    <td>
                                        <a href='{{ route("admin.article.edit", ["id" => $article->id]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("admin.article.destroy", ["id" => $article->id]) }}'
