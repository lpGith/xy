        ...
        <div class="col-xs-12">
            ...
            <div class="box box-solid">
                ...
                <div class="box-header">
                    <p>
                        <a href="{{ url('admin/file-upload') }}?dir={{ $dir }}" class="btn btn-info btn-sm">上传文件</a>
                                ...
                                @foreach($fileList['dirList'] as $dirName)
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{ route('admin.upload.index') }}?dir={{ $dirPath }}">
                                                {{ $dirName }}
                                            </a>
                                        </td>
                                        <td>dir</td>
                                        ...
                                        <td></td>
                                        <td>
                                            <a data-href='{{ route('admin.upload.dir-del') }}?dir={{ $dirPath }}'
                            ...
                            @if ($fileList['fileList'])
                                @foreach($fileList['fileList'] as $file)
                                    <tr>
                                        ...
                                        <td>{{ $file['path'] }}</td>
                                        <td>
                                            <a data-href='{{ route('admin.upload.file-del') }}?file={{ $dir.'/'.$file['file_name'] }}'
        ...
        function mkdir() {
            layer.open({
                ...
                yes: function(index, layero){
                    ...
                    Moell.ajax.postForm("{{ route('admin.upload.mkdir') }}", {dir_name : dirName, dir:dir}, 'POST');
                }
            })
        }
