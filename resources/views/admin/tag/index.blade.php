            ...
            <div class="box box-solid">
                ...
                <div class="box-header">
                    <div class="pull-right">
                        <div class="btn-group">
                            <a href="{{ route('admin.tag.create') }}" class="btn btn-white tooltips"
                        ...
                        @if ($tags)
                            ...
                            @foreach($tags as $tag)
                                <tr>
                                    ...
                                    <td>
                                        <a href='{{ route("admin.tag.edit", ["id" => $tag->id]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("admin.tag.destroy", ["id" => $tag->id]) }}'
