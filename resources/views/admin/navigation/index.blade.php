            ...
            <div class="box box-solid">
                ...
                <div class="box-header">
                    <div class="pull-right">
                        <div class="btn-group">
                            <a href="{{ route('admin.navigation.create') }}" class="btn btn-white tooltips"
                        ...
                        @if ($navigations)
                            ...
                            @foreach($navigations as $navigation)
                                <tr>
                                    ...
                                    <td>
                                        <a href='{{ route("admin.navigation.edit", ["id" => $navigation->id]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("admin.navigation.destroy", ["id" => $navigation->id]) }}'
